...
const STREAMING_CONFIGS: Record<string, StreamingConfig> = {
  ...
  high: {
    ...
    foliageDensityFalloff: [
      ...
      { distance: 120, density: 0.5 },
      { distance: 250, density: 0.2 },
    ],
    terrainLODDistances: [
      { distance: 100, subdivisions: 24 },
      { distance: 200, subdivisions: 12 },
      { distance: 400, subdivisions: 4 },
    ],
  },
  medium: {
    loadDistance: 350,
    ...
    foliageDensityFalloff: [
      ...
      { distance: 100, density: 0.4 },
      { distance: 200, density: 0.1 },
    ],
    terrainLODDistances: [
      { distance: 100, subdivisions: 16 },
      { distance: 200, subdivisions: 8 },
      { distance: 350, subdivisions: 4 },
    ],
  },
  low: {
    loadDistance: 250,
    ...
    foliageDensityFalloff: [
      ...
      { distance: 80, density: 0.3 },
      { distance: 150, density: 0.05 },
    ],
    terrainLODDistances: [
      { distance: 80, subdivisions: 12 },
