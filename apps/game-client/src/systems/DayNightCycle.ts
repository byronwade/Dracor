...
const KEYFRAMES: TimeKeyframe[] = [
  ...
  { // 0.35 — Morning
    time: 0.35,
    sunColor: [1.0, 0.9, 0.7], sunIntensity: 2.2,
    ambientColor: [0.35, 0.32, 0.28], ambientIntensity: 0.6,
    groundColor: [0.15, 0.12, 0.1],
    skyZenith: [0.25, 0.35, 0.6], skyHorizon: [0.5, 0.45, 0.4],
    fogColor: [0.45, 0.43, 0.4], fogDensity: 0.006,
    exposure: 1.2, bloomThreshold: 0.85, bloomWeight: 0.25,
  },
  { // 0.5 — Noon
    time: 0.5,
    sunColor: [1.0, 0.97, 0.9], sunIntensity: 2.8,
    ambientColor: [0.4, 0.4, 0.4], ambientIntensity: 0.7,
    groundColor: [0.18, 0.18, 0.15],
    skyZenith: [0.35, 0.5, 0.8], skyHorizon: [0.6, 0.6, 0.65],
    fogColor: [0.5, 0.5, 0.52], fogDensity: 0.005,
    exposure: 1.3, bloomThreshold: 0.9, bloomWeight: 0.15,
  },
  { // 0.65 — Afternoon
    time: 0.65,
    sunColor: [1.0, 0.88, 0.6], sunIntensity: 2.2,
    ambientColor: [0.35, 0.3, 0.25], ambientIntensity: 0.55,
    groundColor: [0.15, 0.12, 0.08],
    skyZenith: [0.25, 0.35, 0.6], skyHorizon: [0.55, 0.45, 0.35],
    fogColor: [0.45, 0.4, 0.35], fogDensity: 0.006,
    exposure: 1.2, bloomThreshold: 0.8, bloomWeight: 0.25,
  },
