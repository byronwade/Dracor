...
const KEYFRAMES: TimeKeyframe[] = [
  ...
  { // 0.35 — Morning
    time: 0.35,
    sunColor: [1.0, 0.88, 0.65], sunIntensity: 1.6,
    ambientColor: [0.18, 0.17, 0.15], ambientIntensity: 0.45,
    groundColor: [0.08, 0.07, 0.05],
    skyZenith: [0.15, 0.22, 0.45], skyHorizon: [0.35, 0.32, 0.28],
    fogColor: [0.3, 0.3, 0.32], fogDensity: 0.008,
    exposure: 1.0, bloomThreshold: 0.85, bloomWeight: 0.2,
  },
  { // 0.5 — Noon
    time: 0.5,
    sunColor: [1.0, 0.95, 0.88], sunIntensity: 2.0,
    ambientColor: [0.22, 0.22, 0.22], ambientIntensity: 0.5,
    groundColor: [0.1, 0.1, 0.08],
    skyZenith: [0.2, 0.35, 0.65], skyHorizon: [0.45, 0.48, 0.5],
    fogColor: [0.35, 0.37, 0.4], fogDensity: 0.006,
    exposure: 1.05, bloomThreshold: 0.9, bloomWeight: 0.15,
  },
  { // 0.65 — Afternoon
    time: 0.65,
    sunColor: [1.0, 0.85, 0.55], sunIntensity: 1.7,
    ambientColor: [0.2, 0.17, 0.13], ambientIntensity: 0.42,
    groundColor: [0.08, 0.06, 0.04],
    skyZenith: [0.15, 0.22, 0.45], skyHorizon: [0.4, 0.32, 0.22],
    fogColor: [0.32, 0.28, 0.24], fogDensity: 0.008,
    exposure: 1.0, bloomThreshold: 0.8, bloomWeight: 0.22,
  },
