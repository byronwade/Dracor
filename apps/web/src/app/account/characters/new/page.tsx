...
function AccountCharacterCreationContent() {
    ...
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <form onSubmit={handleSubmit} className="space-y-10">
        ...
        <div className="flex gap-4">
          ...
          <Link href="/account/characters" className="btn-secondary">
            Cancel
          </Link>
        </div>
      </form>
...
export default function AccountNewCharacterPage() {
  return (
    <AuthGuard>
      <AccountCharacterCreationContent />
    </AuthGuard>
  );
}
